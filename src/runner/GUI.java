...
//        remButt.setPrefWidth(70);
        ...
        firstField.setPromptText("min");
        secondField = new TextField();
        secondField.setPrefWidth(60);
        secondField.setPromptText("max");
...
//        });
        ...
        gridPane.add(new Label("Weight, kg"), 3, 0);
    ...
    private static void createJacketForViewList(List<Equipment> list, int j) {
        ...
        listViewFeature1.getItems().add("Material: " + jk.getMaterial());
        listViewFeature2.getItems().add("Size: " + jk.getSize());
    }
    ...
    private static void createHelmetForViewList(List<Equipment> list, int j) {
        ...
        listViewWeight.getItems().add(jk.getWeight() + "");
        listViewNameOfEq.getItems().add(jk.getNameOfEquipment());
        listViewFeature1.getItems().add("Color: " + jk.getColor());
        listViewFeature2.getItems().add(jk.isOpen() ? "Open" : "Closed");
    }
    ...
    private static void createGlovesForViewList(List<Equipment> list, int j) {
        ...
        listViewWeight.getItems().add(jk.getWeight() + "");
        listViewNameOfEq.getItems().add(jk.getNameOfEquipment());
        listViewFeature1.getItems().add(jk.isClipped() ? "Clipped" : "Not clipped");
        listViewFeature2.getItems().add("Color: " + jk.getColor());
    }
    ...
    private static void createMotoProtForViewList(List<Equipment> list, int j) {
        ...
        listViewWeight.getItems().add(jk.getWeight() + "");
        listViewNameOfEq.getItems().add(jk.getNameOfEquipment());
        listViewFeature1.getItems().add("Type: " + jk.getTypeProtection());
        listViewFeature2.getItems().add("Size: " + jk.getSize());
    }
